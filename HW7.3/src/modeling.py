...
def get_models(random_state=42):
    return {
        ...
        "RandomForest": RandomForestClassifier(n_estimators=160, random_state=random_state, n_jobs=-1),
        "ExtraTrees": ExtraTreesClassifier(n_estimators=160, random_state=random_state, n_jobs=-1),
